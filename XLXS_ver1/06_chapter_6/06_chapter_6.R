...
Abus_Us_timePlot <-Violinplot(dfXlsxMetComp, dfXlsxMetComp$time, dfXlsxMetComp$methodsVizualisation, "Время", "Метод")
ggsave("~/Documents/Science/ABUS_US_diagnostics/Text_work/Chapters/Chapter6/images6/AbusUsTimeTime.png", 
       plot = Jun_us_timePlot, units = "in", width = 14, height = 8)
