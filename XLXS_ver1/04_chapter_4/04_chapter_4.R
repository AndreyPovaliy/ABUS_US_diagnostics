...
######ABUS#######
dfXlsxSnr_abusRes <- subset(dfXlsxSnr,dfXlsxSnr$abus_skin !="не проводилось")
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS кожа была ",dfXlsxSnr_abusRes$abus_skin)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS размеры узлов были ",dfXlsxSnr_abusRes$abus_nodle_size)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS контуры узлов были ",dfXlsxSnr_abusRes$abus_nodle_contours)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS эхогенность образования ",dfXlsxSnr_abusRes$abus_echogenicity_formation)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS структура узлов ",dfXlsxSnr_abusRes$abus_structure)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS симптом ретракции ",dfXlsxSnr_abusRes$abus_symptom_retraction)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS была установлена категория BIRADS ",dfXlsxSnr_abusRes$abus_category_birads)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS количество узлов ",dfXlsxSnr_abusRes$abus_number_nodles )
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS был поставлен диагноз ",dfXlsxSnr_abusRes$abus_diagnosis)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS были найдены кальцинаты ",dfXlsxSnr_abusRes$abus_calcinates)
Quantity_discr("В выборке 40 лет и старше при выполнении ABUS был поставлен диагноз рак ",dfXlsxSnr_abusRes$abus_is_tumor)
...
chapter_3_4_text("Размер узлов",
                 "В группе C",
                 "В группе D ",
                 dfXlsxGr2$mmg_nodle_size,
                 dfXlsxGr4$mmg_nodle_size,
                 dfXlsxSnr$mmg_nodle_size,
                 dfXlsxSnr$group_separation)
GeomBar(dfXlsxSnr,dfXlsxSnr$mmg_nodle_size,dfXlsxSnr$group_separation,"Размер узлов")
...
chapter_3_4_text("Количество визуализируемых узлов",
                 ...
                 dfXlsxSnr$group_separation)
GeomBar(dfXlsxSnr,dfXlsxSnr$mmg_number_formations_visualized,dfXlsxSnr$group_separation,"Количество визуализируемых узлов")
...
chapter_3_4_text("Количество узлов",
                 ...
                 dfXlsxSnr$group_separation)
GeomBar(dfXlsxSnr,dfXlsxSnr$mmg_number_nodles,dfXlsxSnr$group_separation,"Количество узлов")
