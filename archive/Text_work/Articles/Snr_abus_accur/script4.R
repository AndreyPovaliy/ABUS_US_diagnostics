...
article_text("по результатам выполнения гистологическкого исследования был поставлен дигноз злокачественного образования ",
             "В группе A ",
             "В группе B ",
             dfXlsxGr2Hist$tumor_morphology_structure,
             dfXlsxGr4Hist$tumor_morphology_structure,
             dfXlsxSnrHist$tumor_morphology_structure,
             dfXlsxSnrHist$group_separation)

article_text("по результатам выполнения гистологическкого исследования был поставлен дигноз злокачественного образования ",
             "В группе A ",
             "В группе B ",
             dfXlsxGr2Hist$tumor_receptors,
             dfXlsxGr4Hist$tumor_receptors,
             dfXlsxSnrHist$tumor_receptors,
             dfXlsxSnrHist$group_separation)

article_text("по результатам выполнения гистологическкого исследования был поставлен дигноз злокачественного образования ",
             "В группе A ",
             "В группе B ",
             dfXlsxGr2Hist$degree_malignancy,
             dfXlsxGr4Hist$degree_malignancy,
             dfXlsxSnrHist$degree_malignancy,
             dfXlsxSnrHist$group_separation)



table(dfXlsxSnr$us_category_birads)
table(dfXlsxSnrIsHist$us_category_birads)
length(dfXlsxSnrIsHist$us_category_birads)

x

escribir(paste("|Показатель|Всего|УЗИ|ABUS|ММГ|
|------|------|------|------|------|
|Найдено злокачественных новообразований|", table(dfXlsxGr4$hist_is_tumor)[1] ,"|"
               , table(dfXlsxGr4_usHasFound$hist_is_tumor)[1] ,"|"
               , table(dfXlsxGr4_abusHasFound$hist_is_tumor)[1] ,"|"
               , table(dfXlsxGr4_mmgHasFound$hist_is_tumor)[1] ,"|
|Гистология|------|------|------|------|
|",data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][1,1],"|",
               data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$tumor_morphology_structure))[c(1,2,7),][1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$tumor_morphology_structure))[c(1,2,7),][1,2],"|",
               data.frame(table(dfXlsxGr4_mmgHasFound$tumor_morphology_structure))[c(1,2,7),][1,2],"
|",data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][2,1],"|",
               data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$tumor_morphology_structure))[c(1,2,7),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$tumor_morphology_structure))[c(1,2,7),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$tumor_morphology_structure))[c(1,2,7),][2,2],"
|",data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][3,1],"|",
               data.frame(table(dfXlsxGr4$tumor_morphology_structure))[c(1,2,7),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$tumor_morphology_structure))[c(1,2,7),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$tumor_morphology_structure))[c(1,2,7),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$tumor_morphology_structure))[c(1,2,7),][3,2],"
|Уровень злокачестванности|------|------|------|------|
|",data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][1,1],"|",
               data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$degree_malignancy))[c(1,2,3),][1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$degree_malignancy))[c(1,2,3),][1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$degree_malignancy))[c(1,2,3),][1,2],"|
|",data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][2,1],"|",
               data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$degree_malignancy))[c(1,2,3),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$degree_malignancy))[c(1,2,3),][2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$degree_malignancy))[c(1,2,3),][2,2],"|
|",data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][3,1],"|",
               data.frame(table(dfXlsxGr4$degree_malignancy))[c(1,2,3),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$degree_malignancy))[c(1,2,3),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$degree_malignancy))[c(1,2,3),][3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$degree_malignancy))[c(1,2,3),][3,2],"|
|Размер|------|------|------|------|
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[1,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[1,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[1,2],"|
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[2,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[2,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[2,2],"|
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[3,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[3,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[3,2],"| 
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[4,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[4,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[4,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[4,2],"| 
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[5,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[5,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[5,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[5,2],"|
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[6,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[6,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[6,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[6,2],"|
|",data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[7,1],"|------|",
               data.frame(table(dfXlsxGr4_cancerFromUsHasFound$us_nodle_size))[7,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromAbusHasFound$abus_nodle_size))[7,2],"|",
               data.frame(table(dfXlsxGr4_cancerFromMmgHasFound$mmg_nodle_size))[7,2],"|"))


pvalueQualitativeText(dfXlsxMetCompAbusMmg$metod_is_tumor,dfXlsxMetCompAbusMmg$methodsVizualisation,"text")



# 1.Все раки ( сколько было визуализировано на каждом методе и используя два метода вместе)
# 2. Гистология
# 3. Grade
# 4.размер( разбить) как к нам в исходных данных)
