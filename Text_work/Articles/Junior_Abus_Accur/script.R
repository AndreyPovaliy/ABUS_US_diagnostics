...
article_text("по результатам выполнения гистологическкого исследования был поставлен дигноз злокачественного образования ",
             "В группе A ",
             "В группе B ",
             dfXlsxGr1Hist$tumor_receptors,
             dfXlsxGr3Hist$tumor_receptors,
             dfXlsxJunHist$tumor_receptors,
             dfXlsxJunHist$group_separation)

article_text("по результатам выполнения гистологическкого исследования был поставлен дигноз злокачественного образования ",
             "В группе A ",
             "В группе B ",
             dfXlsxGr1Hist$degree_malignancy,
             dfXlsxGr3Hist$degree_malignancy,
             dfXlsxJunHist$degree_malignancy,
             dfXlsxJunHist$group_separation)


dfXlsxJunIsHist <- subset(dfXlsxJun, dfXlsxJun$tumor_morphology_structure !="не проводилось")
table(dfXlsxJun$us_category_birads)
table(dfXlsxJunIsHist$us_category_birads)
length(dfXlsxJunIsHist$us_category_birads)
