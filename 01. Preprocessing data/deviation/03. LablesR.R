...
dfMrsiDescribe$mrsi_number_nodles <- replace(dfMrsiDescribe$mrsi_number_nodles, is.na(dfDescribeMrsi$mrsi_number_nodles), 0)
...
# #####Add columns####
# dfUsDiagnosis$isTumor <- factor(ifelse
