...
dfUsDescribe$us_region_lymph_nodes	<- 	factor(dfUsDescribe$us_region_lymph_nodes,
                                              ...
                                              labels = c(
                                                "0"="не изменены",
                                                "1"="в правая надключичная область",
                                                "2"="в левая надключичная область",
                                                "3"="в правая подключичная область",
                                                "4"="в левая подключичная область",
                                                "5"="в правая подмышечная область",
                                                "6"="в левая подмышечная область"
                                              ))
...
dfUsDiagnosis$is_tumor <- factor(ifelse
                                 (dfUsDiagnosis$us_diagnosis == "образование Ca"
                                   | dfUsDiagnosis$us_diagnosis == "мультфококальный рак"
                                   | dfUsDiagnosis$us_diagnosis == "мультицентричный рак"
                                   , 1, 0),
                                 labels = c("Нет", "Да"))
...
dfAbusDiagnosis$is_tumor <- factor(ifelse
                                   (dfAbusDiagnosis$abus_diagnosis == "образование Ca"
                                     | dfAbusDiagnosis$abus_diagnosis == "мультифокальный рак"
                                     | dfAbusDiagnosis$abus_diagnosis== "мультицентричный рак"
                                     , 1, 0),
                                   labels = c("Нет", "Да"))
